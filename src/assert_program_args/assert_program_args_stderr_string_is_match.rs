...
#[cfg(test)]
mod test_assert_program_args_stderr_string_is_match {
    use regex::Regex;
    use std::panic;
...
#[cfg(test)]
mod test_debug_assert_program_args_stderr_string_is_match {
    use regex::Regex;
    use std::panic;
    ...
    fn success() {
        ...
        let b = Regex::new(r"lf").expect("regex");
        for _ in 0..1 {
            let _actual = debug_assert_program_args_stderr_string_is_match!(a_program, a_args, b);
            // assert_eq!(actual, "alfa");
        }
    }
