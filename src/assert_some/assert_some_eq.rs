...
#[cfg(test)]
mod test_assert_some_eq_as_result {
    use std::sync::Once;
...
mod test_assert_some_eq {
    ...
    fn ne() {
        ...
        let b: Option<i8> = Option::Some(2);
        let result = panic::catch_unwind(|| {
            let _actual = assert_some_eq!(a, b);
        });
        let message = concat!(
            "assertion failed: `assert_some_eq!(a, b)`\n",
            "https://docs.rs/assertables/10.0.0/assertables/macro.assert_some_eq.html\n",
...
mod test_debug_assert_some_eq {
    ...
    fn eq() {
        ...
        let b: Option<i8> = Option::Some(1);
        for _ in 0..1 {
            let _actual = debug_assert_some_eq!(a, b);
            // assert_eq!(actual, (1, 1));
        }
    }
