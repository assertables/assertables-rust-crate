...
#[cfg(test)]
mod test_assert_fn_ok_eq_as_result {
    // use std::sync::Once;
    ...
    mod arity_0 {
        ...
        #[test]
        fn ne() {
            let actual = assert_fn_ok_eq_as_result!(f, g);
            let message = concat!(
                "assertion failed: `assert_fn_ok_eq!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.1.0/assertables/macro.assert_fn_ok_eq.html\n",
                " a_function label: `f`,\n",
...
mod test_assert_fn_ok_eq {
    ...
    mod arity_1 {
        ...
        fn eq() {
            ...
            let b: i8 = 1;
            for _ in 0..1 {
                let actual = assert_fn_ok_eq!(f, a, g, b);
                let expect = (1, 1);
    ...
    mod arity_0 {
        ...
        fn ne() {
            let result = panic::catch_unwind(|| {
                let _actual = assert_fn_ok_eq!(f, g);
            });
            let message = concat!(
                "assertion failed: `assert_fn_ok_eq!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.1.0/assertables/macro.assert_fn_ok_eq.html\n",
...
macro_rules! debug_assert_fn_ok_eq {
    ($($arg:tt)*) => {
        if cfg!(debug_assertions) {
            $crate::assert_fn_ok_eq!($($arg)*);
        }
    };
}

#[cfg(test)]
mod test_debug_assert_fn_ok_eq {
    use std::panic;
    ...
    mod arity_1 {
        ...
        fn eq() {
            ...
            let b: i8 = 1;
            for _ in 0..1 {
                let _actual = debug_assert_fn_ok_eq!(f, a, g, b);
                let _expect = (1, 1);
                // assert_eq!(actual, expect);
            }
        }
    ...
    mod arity_0 {
        ...
        fn eq() {
            for _ in 0..1 {
                let _actual = debug_assert_fn_ok_eq!(f, f);
                let _expect = (1, 1);
                // assert_eq!(actual, expect);
            }
        }
        ...
        fn ne() {
            let result = panic::catch_unwind(|| {
                let _actual = debug_assert_fn_ok_eq!(f, g);
            });
            let message = concat!(
                "assertion failed: `assert_fn_ok_eq!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.1.0/assertables/macro.assert_fn_ok_eq.html\n",
