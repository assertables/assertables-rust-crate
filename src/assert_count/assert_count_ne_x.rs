...
#[cfg(test)]
mod test_assert_count_ne_x_as_result {
    use std::sync::Once;
    ...
    fn lt_once() {
        ...
        let result = assert_count_ne_x_as_result!(a(), b());
        assert!(result.is_ok());
...
mod test_assert_count_ne_x {
    ...
    fn lt() {
        ...
        let b = 2;
        for _ in 0..1 {
            let actual = assert_count_ne_x!(a, b);
    ...
    fn failure() {
        let result = panic::catch_unwind(|| {
            let a = "x".chars();
            let b = 1;
            let _actual = assert_count_ne_x!(a, b);
        });
        let message = concat!(
            "assertion failed: `assert_count_ne_x!(a, b)`\n",
            "https://docs.rs/assertables/10.0.0/assertables/macro.assert_count_ne_x.html\n",
