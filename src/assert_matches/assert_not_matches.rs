...
mod test_assert_not_matches {
    ...
    mod use_char {
        ...
        fn success_with_custom_message() {
            let a = 'a';
            let actual = assert_not_matches!(a, 'b'..='z', "a is {a}");
            assert_eq!(actual, ());
        }
        ...
        fn failure_with_custom_message() {
            let a = 'a';
            let result = panic::catch_unwind(|| {
                let _actual = assert_not_matches!(a, 'a'..='z', "a is {a}");
            });
            let message = concat!(
                "a is a\n",
                "assertion failed: `assert_not_matches!(a)`\n",
    ...
    mod use_some {
        ...
        fn success_with_custom_message() {
            let a = Some(2);
            let actual = assert_not_matches!(a, Some(x) if x < 2, "a is {:?}", a);
            assert_eq!(actual, ());
        }
        ...
        fn failure_with_custom_message() {
            let a = Some(1);
            let result = panic::catch_unwind(|| {
                let _actual = assert_not_matches!(a, Some(x) if x < 2, "a is {:?}", a);
            });
            let message = concat!(
                "a is Some(1)\n",
                "assertion failed: `assert_not_matches!(a)`\n",
...
#[cfg(test)]
mod test_debug_assert_not_matches {
    ...
    mod use_char {
        ...
        fn success() {
            let a = 'a';
            let _actual = debug_assert_not_matches!(a, 'b'..='z');
            // assert_eq!(actual, ());
        }
        ...
        fn success_with_custom_message() {
            let a = 'a';
            let _actual = debug_assert_not_matches!(a, 'b'..='z', "a is {a}");
            // assert_eq!(actual, ());
        }
        ...
        fn failure() {
            let a = 'a';
            let result = panic::catch_unwind(|| {
                let _actual = debug_assert_not_matches!(a, 'a'..='z');
            });
            let message = concat!(
                "assertion failed: `assert_not_matches!(a)`\n",
                "https://docs.rs/assertables/10.1.0/assertables/macro.assert_not_matches.html\n",
        ...
        fn failure_with_custom_message() {
            let a = 'a';
            let result = panic::catch_unwind(|| {
                let _actual = debug_assert_not_matches!(a, 'a'..='z', "a is {a}");
            });
            let message = concat!(
                "a is a\n",
                "assertion failed: `assert_not_matches!(a)`\n",
    ...
    mod use_some {
        ...
        fn success() {
            let a = Some(2);
            let _actual = debug_assert_not_matches!(a, Some(x) if x < 2);
            // assert_eq!(actual, ());
        }
        ...
        fn success_with_custom_message() {
            let a = Some(2);
            let _actual = debug_assert_not_matches!(a, Some(x) if x < 2, "a is {:?}", a);
            // assert_eq!(actual, ());
        }
