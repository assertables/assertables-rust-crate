...
#[cfg(test)]
mod test_assert_fn_ne_as_result {
    // use std::sync::Once;
    ...
    mod arity_1 {
        ...
        fn failure() {
            let result = panic::catch_unwind(|| {
                let a: i8 = 1;
                let b: i8 = 1;
                let _actual = assert_fn_ne!(f, a, g, b);
            });
            let message = concat!(
                "assertion failed: `assert_fn_ne!(a_function, a_param, b_function, b_param)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_ne.html\n",
...
mod test_debug_assert_fn_ne {
    ...
    mod arity_1 {
        ...
        fn ne() {
            ...
            let b: i8 = 2;
            for _ in 0..1 {
                let _actual = debug_assert_fn_ne!(f, a, g, b);
                let _expect = (1, 2);
                // assert_eq!(actual, expect);
            }
        }
    ...
    mod arity_0 {
        ...
        fn ne() {
            for _ in 0..1 {
                let _actual = debug_assert_fn_ne!(f, g);
                let _expect = (1, 2);
                // assert_eq!(actual, expect);
            }
        }
        ...
        fn eq() {
            let result = panic::catch_unwind(|| {
                let _actual = debug_assert_fn_ne!(f, f);
            });
            let message = concat!(
                "assertion failed: `assert_fn_ne!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_ne.html\n",
