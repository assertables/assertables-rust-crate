...
mod test_assert_not_starts_with {
    ...
    fn success() {
        ...
        let subsequence = "fa";
        for _ in 0..1 {
            let actual = assert_not_starts_with!(sequence, subsequence);
            assert_eq!(actual, ());
        }
    }
    ...
    fn failure() {
        ...
        let subsequence = "al";
        let result = panic::catch_unwind(|| {
            let _actual = assert_not_starts_with!(sequence, subsequence);
        });
        let message = concat!(
            "assertion failed: `assert_not_starts_with!(sequence, subsequence)`\n",
            "https://docs.rs/assertables/10.1.0/assertables/macro.assert_not_starts_with.html\n",
...
#[cfg(test)]
mod test_debug_assert_not_starts_with {
    use std::panic;
    ...
    fn success() {
        ...
        let subsequence = "fa";
        for _ in 0..1 {
            let _actual = debug_assert_not_starts_with!(sequence, subsequence);
            // assert_eq!(actual, ());
        }
    }
