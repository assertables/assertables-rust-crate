...
mod test_assert_program_args_stderr_ge_as_result {
    ...
    fn gt() {
        ...
        let b_program = "bin/printf-stderr";
        let b_args = ["%s", "aa"];
        let actual = assert_program_args_stderr_ge_as_result!(a_program, a_args, b_program, b_args);
        assert_eq!(
            actual.unwrap(),
...
#[cfg(test)]
mod test_assert_program_args_stderr_ge {
    use std::panic;
    ...
    fn gt() {
        ...
        let b_args = ["%s", "aa"];
        for _ in 0..1 {
            let actual = assert_program_args_stderr_ge!(a_program, a_args, b_program, b_args);
    ...
    fn lt() {
        ...
        let b_args = ["%s", "zz"];
        let result = panic::catch_unwind(|| {
            let _actual = assert_program_args_stderr_ge!(a_program, a_args, b_program, b_args);
        });
        let message = concat!(
            "assertion failed: `assert_program_args_stderr_ge!(a_program, a_args, b_program, b_args)`\n",
            "https://docs.rs/assertables/10.1.0/assertables/macro.assert_program_args_stderr_ge.html\n",
...
#[cfg(test)]
mod test_debug_assert_program_args_stderr_ge {
    use std::panic;
    ...
    fn gt() {
        ...
        for _ in 0..1 {
            let _actual =
                debug_assert_program_args_stderr_ge!(a_program, a_args, b_program, b_args);
            // assert_eq!(actual, (vec![b'a', b'l', b'f', b'a'], vec![b'a', b'a']));
        }
    }
    ...
    fn eq() {
        ...
        let b_program = "bin/printf-stderr";
        let b_args = ["%s", "alfa"];
        let _actual = debug_assert_program_args_stderr_ge!(a_program, a_args, b_program, b_args);
        // assert_eq!(actual, (vec![b'a', b'l', b'f', b'a'], vec![b'a', b'l', b'f', b'a']));
    }
