...
//! # Module macros
//!
//! * [`assert_any_le_x`](macro@crate::assert_any_le_x)
//! * [`assert_any_le_x_as_result`](macro@crate::assert_any_le_x_as_result)
//! * [`debug_assert_any_le_x`](macro@crate::debug_assert_any_le_x)
...
/// # });
/// // assertion failed: `assert_any_le_x!(iter, x)`
/// // https://docs.rs/assertables/…/assertables/macro.assert_any_le_x.html
/// //  iter label: `a.iter()`,
/// //  iter debug: `Iter([])`,
/// //  x label: `b`,\n",
/// //  x debug: `0`",
...
/// iter ∃ ≤ x
///
/// This macro provides the same statements as [`assert_any_le_x`](macro.assert_any_le_x.html),
