...
#[cfg(test)]
mod test_assert_fn_err_le_as_result {
    // use std::sync::Once;
    ...
    mod arity_1 {
        ...
        fn lt() {
            ...
            let b: i8 = 2;
            for _ in 0..1 {
                let actual = assert_fn_err_le_as_result!(f, a, g, b);
    ...
    mod arity_0 {
        ...
        fn lt() {
            for _ in 0..1 {
                let actual = assert_fn_err_le_as_result!(f, g);
                assert_eq!(actual.unwrap(), (1, 2));
            }
        }
        ...
        fn eq() {
            for _ in 0..1 {
                let actual = assert_fn_err_le_as_result!(f, f);
                assert_eq!(actual.unwrap(), (1, 1));
            }
        }
        ...
        #[test]
        fn gt() {
            let actual = assert_fn_err_le_as_result!(g, f);
            let message = concat!(
                "assertion failed: `assert_fn_err_le!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_le.html\n",
                " a_function label: `g`,\n",
...
mod test_assert_fn_err_le {
    ...
    mod arity_1 {
        ...
        fn lt() {
            ...
            let b: i8 = 2;
            for _ in 0..1 {
                let actual = assert_fn_err_le!(f, a, g, b);
                let expect = (1, 2);
        ...
        fn gt() {
            let result = panic::catch_unwind(|| {
                let a: i8 = 2;
                let b: i8 = 1;
                let _actual = assert_fn_err_le!(f, a, g, b);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_le!(a_function, a_param, b_function, b_param)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_le.html\n",
    ...
    mod arity_0 {
        ...
        fn lt() {
            for _ in 0..1 {
                let actual = assert_fn_err_le!(f, g);
                let expect = (1, 2);
                assert_eq!(actual, expect);
            }
        }
        ...
        fn eq() {
            for _ in 0..1 {
                let actual = assert_fn_err_le!(f, f);
                let expect = (1, 1);
                assert_eq!(actual, expect);
            }
        }
        ...
        fn gt() {
            let result = panic::catch_unwind(|| {
                let _actual = assert_fn_err_le!(g, f);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_le!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_le.html\n",
...
macro_rules! debug_assert_fn_err_le {
    ($($arg:tt)*) => {
        if cfg!(debug_assertions) {
            $crate::assert_fn_err_le!($($arg)*);
        }
    };
}

#[cfg(test)]
mod test_debug_assert_fn_err_le {
    use std::panic;
    ...
    mod arity_1 {
        ...
        fn lt() {
            ...
            let b: i8 = 2;
            for _ in 0..1 {
                let _actual = debug_assert_fn_err_le!(f, a, g, b);
                let _expect = (1, 2);
                // assert_eq!(actual, expect);
            }
        }
    ...
    mod arity_0 {
        ...
        fn lt() {
            for _ in 0..1 {
                let _actual = debug_assert_fn_err_le!(f, g);
                let _expect = (1, 2);
                // assert_eq!(actual, expect);
            }
        }
        ...
        fn eq() {
            for _ in 0..1 {
                let _actual = debug_assert_fn_err_le!(f, f);
                let _expect = (1, 1);
                // assert_eq!(actual, expect);
            }
        }
        ...
        fn gt() {
            let result = panic::catch_unwind(|| {
                let _actual = debug_assert_fn_err_le!(g, f);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_le!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_le.html\n",
