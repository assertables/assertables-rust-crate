...
#[cfg(test)]
mod test_assert_count_le_as_result {
    use std::sync::Once;
...
mod test_assert_count_le {
    ...
    fn gt() {
        ...
        let b = "xx".chars();
        for _ in 0..1 {
            let actual = assert_count_le!(a, b);
    ...
    fn lt() {
        let result = panic::catch_unwind(|| {
            let a = "xx".chars();
            let b = "x".chars();
            let _actual = assert_count_le!(a, b);
        });
        let message = concat!(
            "assertion failed: `assert_count_le!(a, b)`\n",
            "https://docs.rs/assertables/10.0.0/assertables/macro.assert_count_le.html\n",
...
#[cfg(test)]
mod test_debug_assert_count_le {
    use std::panic;
    ...
    fn gt() {
        ...
        let b = "xx".chars();
        for _ in 0..1 {
            let _actual = debug_assert_count_le!(a, b);
            // assert_eq!(actual, (1, 2));
        }
    }
