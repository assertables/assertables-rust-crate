...
#[cfg(test)]
mod test_assert_fn_err_ge_as_result {
    // use std::sync::Once;
    ...
    mod arity_1 {
        ...
        fn gt() {
            ...
            let b: i8 = 1;
            for _ in 0..1 {
                let actual = assert_fn_err_ge_as_result!(f, a, g, b);
    ...
    mod arity_0 {
        ...
        fn gt() {
            for _ in 0..1 {
                let actual = assert_fn_err_ge_as_result!(g, f);
                assert_eq!(actual.unwrap(), (2, 1));
            }
        }
        ...
        fn eq() {
            for _ in 0..1 {
                let actual = assert_fn_err_ge_as_result!(f, f);
                assert_eq!(actual.unwrap(), (1, 1));
            }
        }
        ...
        #[test]
        fn lt() {
            let actual = assert_fn_err_ge_as_result!(f, g);
            let message = concat!(
                "assertion failed: `assert_fn_err_ge!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.1.0/assertables/macro.assert_fn_err_ge.html\n",
                " a_function label: `f`,\n",
...
mod test_assert_fn_err_ge {
    ...
    mod arity_1 {
        ...
        fn gt() {
            ...
            let b: i8 = 1;
            for _ in 0..1 {
                let actual = assert_fn_err_ge!(f, a, g, b);
                let expect = (2, 1);
        ...
        fn lt() {
            let result = panic::catch_unwind(|| {
                let a: i8 = 1;
                let b: i8 = 2;
                let _actual = assert_fn_err_ge!(f, a, g, b);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_ge!(a_function, a_param, b_function, b_param)`\n",
                "https://docs.rs/assertables/10.1.0/assertables/macro.assert_fn_err_ge.html\n",
    ...
    mod arity_0 {
        ...
        fn gt() {
            for _ in 0..1 {
                let actual = assert_fn_err_ge!(g, f);
                let expect = (2, 1);
                assert_eq!(actual, expect);
            }
        }
        ...
        fn eq() {
            for _ in 0..1 {
                let actual = assert_fn_err_ge!(f, f);
                let expect = (1, 1);
                assert_eq!(actual, expect);
            }
        }
        ...
        fn lt() {
            let result = panic::catch_unwind(|| {
                let _actual = assert_fn_err_ge!(f, g);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_ge!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.1.0/assertables/macro.assert_fn_err_ge.html\n",
...
#[cfg(test)]
mod test_debug_assert_fn_err_ge {
    use std::panic;
    ...
    mod arity_1 {
        ...
        fn gt() {
            ...
            let b: i8 = 1;
            for _ in 0..1 {
                let _actual = debug_assert_fn_err_ge!(f, a, g, b);
                let _expect = (2, 1);
                // assert_eq!(actual, expect);
            }
        }
    ...
    mod arity_0 {
        ...
        fn gt() {
            for _ in 0..1 {
                let _actual = debug_assert_fn_err_ge!(g, f);
                let _expect = (2, 1);
                // assert_eq!(actual, expect);
            }
        }
        ...
        fn eq() {
            for _ in 0..1 {
                let _actual = debug_assert_fn_err_ge!(f, f);
                let _expect = (1, 1);
                // assert_eq!(actual, expect);
            }
        }
        ...
        fn lt() {
            let result = panic::catch_unwind(|| {
                let _actual = debug_assert_fn_err_ge!(f, g);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_ge!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.1.0/assertables/macro.assert_fn_err_ge.html\n",
