...
#[cfg(test)]
mod test_assert_status_code_value_ge_x {
    use std::panic;
    use std::process::Command;
    ...
    fn lt() {
        let result = panic::catch_unwind(|| {
            ...
            a.arg("1");
            let b = 2;
            let _actual = assert_status_code_value_ge_x!(a, b);
        });
        let message = concat!(
            "assertion failed: `assert_status_code_value_ge_x!(a, b)`\n",
            "https://docs.rs/assertables/10.1.0/assertables/macro.assert_status_code_value_ge_x.html\n",
...
#[cfg(test)]
mod test_debug_assert_status_code_value_ge_x {
    use std::panic;
    use std::process::Command;
    ...
    fn gt() {
        ...
        let b = 1;
        for _ in 0..1 {
            let _actual = debug_assert_status_code_value_ge_x!(a, b);
            // assert_eq!(actual, 2);
        }
    }
