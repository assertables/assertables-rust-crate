...
#[cfg(test)]
mod test_assert_fs_read_to_string_ne_as_result {
...
#[cfg(test)]
mod test_assert_fs_read_to_string_ne {
    #[allow(unused_imports)]
    use std::io::Read;
    use std::panic;
    use std::path::PathBuf;
...
#[cfg(test)]
mod test_debug_assert_fs_read_to_string_ne {
    #[allow(unused_imports)]
    use std::io::Read;
    use std::panic;
    use std::path::PathBuf;
    ...
    fn lt() {
        ...
        let b = DIR.join("bravo.txt");
        for _ in 0..1 {
            let _actual = debug_assert_fs_read_to_string_ne!(a, b);
            // assert_eq!(actual, (String::from("alfa\n"), String::from("bravo\n")));
        }
    }
