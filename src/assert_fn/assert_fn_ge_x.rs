...
#[cfg(test)]
mod test_assert_fn_ge_x_as_result {
    // use std::sync::Once;
...
mod test_assert_fn_ge_x {
    ...
    mod arity_1 {
        ...
        fn lt() {
            let result = panic::catch_unwind(|| {
                let a: i8 = 1;
                let b: i8 = 2;
                let _actual = assert_fn_ge_x!(f, a, b);
            });
            let message = concat!(
                "assertion failed: `assert_fn_ge_x!(a_function, a_param, b_expr)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_ge_x.html\n",
    ...
    mod arity_0 {
        ...
        fn lt() {
            let result = panic::catch_unwind(|| {
                let b: i8 = 2;
                let _actual = assert_fn_ge_x!(f, b);
            });
            let message = concat!(
                "assertion failed: `assert_fn_ge_x!(a_function, b_expr)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_ge_x.html\n",
...
mod test_debug_assert_fn_ge_x {
    ...
    mod arity_1 {
        ...
        fn gt() {
            ...
            let b: i8 = 1;
            for _ in 0..1 {
                let _actual = debug_assert_fn_ge_x!(f, a, b);
                let _expect = 2;
                // assert_eq!(actual, expect);
            }
        }
    ...
    mod arity_0 {
        ...
        fn gt() {
            let b: i8 = 1;
            for _ in 0..1 {
                let _actual = debug_assert_fn_ge_x!(g, b);
                let _expect = 2;
                // assert_eq!(actual, expect);
            }
        }
        ...
        fn lt() {
            let result = panic::catch_unwind(|| {
                let b: i8 = 2;
                let _actual = debug_assert_fn_ge_x!(f, b);
            });
            let message = concat!(
                "assertion failed: `assert_fn_ge_x!(a_function, b_expr)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_ge_x.html\n",
