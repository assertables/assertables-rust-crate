...
#[cfg(test)]
mod test_assert_fn_err_eq_as_result {
    // use std::sync::Once;
    ...
    mod arity_1 {
        ...
        fn eq() {
            ...
            let b: i8 = 1;
            for _ in 0..1 {
                let actual = assert_fn_err_eq_as_result!(f, a, g, b);
    ...
    mod arity_0 {
        ...
        fn eq() {
            for _ in 0..1 {
                let actual = assert_fn_err_eq_as_result!(f, f);
                assert_eq!(actual.unwrap(), (1, 1));
            }
        }
        ...
        #[test]
        fn ne() {
            let actual = assert_fn_err_eq_as_result!(f, g);
            let message = concat!(
                "assertion failed: `assert_fn_err_eq!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_eq.html\n",
                " a_function label: `f`,\n",
...
mod test_assert_fn_err_eq {
    ...
    mod arity_1 {
        ...
        fn eq() {
            ...
            let b: i8 = 1;
            for _ in 0..1 {
                let actual = assert_fn_err_eq!(f, a, g, b);
                let expect = (1, 1);
        ...
        fn ne() {
            let result = panic::catch_unwind(|| {
                let a: i8 = 1;
                let b: i8 = 2;
                let _actual = assert_fn_err_eq!(f, a, g, b);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_eq!(a_function, a_param, b_function, b_param)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_eq.html\n",
    ...
    mod arity_0 {
        ...
        fn eq() {
            for _ in 0..1 {
                let actual = assert_fn_err_eq!(f, f);
                let expect = (1, 1);
                assert_eq!(actual, expect);
            }
        }
        ...
        fn ne() {
            let result = panic::catch_unwind(|| {
                let _actual = assert_fn_err_eq!(f, g);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_eq!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_eq.html\n",
...
#[cfg(test)]
mod test_debug_assert_fn_err_eq {
    use std::panic;
    ...
    mod arity_1 {
        ...
        fn eq() {
            ...
            let b: i8 = 1;
            for _ in 0..1 {
                let _actual = debug_assert_fn_err_eq!(f, a, g, b);
                let _expect = (1, 1);
                // assert_eq!(actual, expect);
            }
        }
    ...
    mod arity_0 {
        ...
        fn eq() {
            for _ in 0..1 {
                let _actual = debug_assert_fn_err_eq!(f, f);
                let _expect = (1, 1);
                // assert_eq!(actual, expect);
            }
        }
        ...
        fn ne() {
            let result = panic::catch_unwind(|| {
                let _actual = debug_assert_fn_err_eq!(f, g);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_eq!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_eq.html\n",
