...
mod test_assert_fn_err_eq_x_as_result {
    ...
    mod arity_1 {
        ...
        fn eq() {
            ...
            let b: i8 = 1;
            for _ in 0..1 {
                let actual = assert_fn_err_eq_x_as_result!(f, a, b);
    ...
    mod arity_0 {
        ...
        fn eq() {
            for _ in 0..1 {
                let actual = assert_fn_err_eq_x_as_result!(f, 1);
                assert_eq!(actual.unwrap(), 1);
            }
        }
        ...
        fn ne() {
            let b: i8 = 2;
            let actual = assert_fn_err_eq_x_as_result!(f, b);
            let message = concat!(
                "assertion failed: `assert_fn_err_eq_x!(a_function, b_expr)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_eq_x.html\n",
                " a_function label: `f`,\n",
...
mod test_assert_fn_err_eq_x {
    ...
    mod arity_1 {
        ...
        fn eq() {
            ...
            let b: i8 = 1;
            for _ in 0..1 {
                let actual = assert_fn_err_eq_x!(f, a, b);
                let expect = 1;
        ...
        fn ne() {
            let result = panic::catch_unwind(|| {
                let a: i8 = 1;
                let b: i8 = 2;
                let _actual = assert_fn_err_eq_x!(f, a, b);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_eq_x!(a_function, a_param, b_expr)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_eq_x.html\n",
    ...
    mod arity_0 {
        ...
        fn eq() {
            for _ in 0..1 {
                let actual = assert_fn_err_eq_x!(f, 1);
                let expect = 1;
                assert_eq!(actual, expect);
            }
        }
        ...
        fn ne() {
            let result = panic::catch_unwind(|| {
                let b: i8 = 2;
                let _actual = assert_fn_err_eq_x!(f, b);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_eq_x!(a_function, b_expr)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_eq_x.html\n",
...
macro_rules! debug_assert_fn_err_eq_x {
    ($($arg:tt)*) => {
        if cfg!(debug_assertions) {
            $crate::assert_fn_err_eq_x!($($arg)*);
        }
    };
}

#[cfg(test)]
mod test_debug_assert_fn_err_eq_x {
    use std::panic;
    ...
    mod arity_1 {
        ...
        fn eq() {
            ...
            let b: i8 = 1;
            for _ in 0..1 {
                let _actual = debug_assert_fn_err_eq_x!(f, a, b);
                let _expect = 1;
                // assert_eq!(actual, expect);
            }
        }
    ...
    mod arity_0 {
        ...
        fn eq() {
            for _ in 0..1 {
                let _actual = debug_assert_fn_err_eq_x!(f, 1);
                let _expect = 1;
                // assert_eq!(actual, expect);
            }
        }
        ...
        fn ne() {
            let result = panic::catch_unwind(|| {
                let b: i8 = 2;
                let _actual = debug_assert_fn_err_eq_x!(f, b);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_eq_x!(a_function, b_expr)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_eq_x.html\n",
