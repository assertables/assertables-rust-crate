...
#[cfg(test)]
mod test_assert_fn_err_lt_as_result {
    // use std::sync::Once;
    ...
    mod arity_1 {
        ...
        fn lt() {
            ...
            let b: i8 = 2;
            for _ in 0..1 {
                let actual = assert_fn_err_lt_as_result!(f, a, g, b);
    ...
    mod arity_0 {
        ...
        fn lt() {
            for _ in 0..1 {
                let actual = assert_fn_err_lt_as_result!(f, g);
                assert_eq!(actual.unwrap(), (1, 2));
            }
        }
        ...
        #[test]
        fn eq() {
            let actual = assert_fn_err_lt_as_result!(f, f);
            let message = concat!(
                "assertion failed: `assert_fn_err_lt!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_lt.html\n",
                " a_function label: `f`,\n",
        ...
        #[test]
        fn gt() {
            let actual = assert_fn_err_lt_as_result!(g, f);
            let message = concat!(
                "assertion failed: `assert_fn_err_lt!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_lt.html\n",
                " a_function label: `g`,\n",
...
mod test_assert_fn_err_lt {
    ...
    mod arity_1 {
        ...
        fn lt() {
            ...
            let b: i8 = 2;
            for _ in 0..1 {
                let actual = assert_fn_err_lt!(f, a, g, b);
                let expect = (1, 2);
        ...
        fn eq() {
            let result = panic::catch_unwind(|| {
                let a: i8 = 1;
                let b: i8 = 1;
                let _actual = assert_fn_err_lt!(f, a, g, b);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_lt!(a_function, a_param, b_function, b_param)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_lt.html\n",
    ...
    mod arity_0 {
        ...
        fn lt() {
            for _ in 0..1 {
                let actual = assert_fn_err_lt!(f, g);
                let expect = (1, 2);
                assert_eq!(actual, expect);
            }
        }
        ...
        fn eq() {
            let result = panic::catch_unwind(|| {
                let _actual = assert_fn_err_lt!(f, f);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_lt!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_lt.html\n",
        ...
        fn gt() {
            let result = panic::catch_unwind(|| {
                let _actual = assert_fn_err_lt!(g, f);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_lt!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_lt.html\n",
...
#[cfg(test)]
mod test_debug_assert_fn_err_lt {
    use std::panic;
    ...
    mod arity_1 {
        ...
        fn lt() {
            ...
            let b: i8 = 2;
            for _ in 0..1 {
                let _actual = debug_assert_fn_err_lt!(f, a, g, b);
                let _expect = (1, 2);
                // assert_eq!(actual, expect);
            }
        }
    ...
    mod arity_0 {
        ...
        fn lt() {
            for _ in 0..1 {
                let _actual = debug_assert_fn_err_lt!(f, g);
                let _expect = (1, 2);
                // assert_eq!(actual, expect);
            }
        }
        ...
        fn eq() {
            let result = panic::catch_unwind(|| {
                let _actual = debug_assert_fn_err_lt!(f, f);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_lt!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_lt.html\n",
        ...
        fn gt() {
            let result = panic::catch_unwind(|| {
                let _actual = debug_assert_fn_err_lt!(g, f);
            });
            let message = concat!(
                "assertion failed: `assert_fn_err_lt!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.0.0/assertables/macro.assert_fn_err_lt.html\n",
