...
#[cfg(test)]
mod test_assert_iter_eq_as_result {
    // use std::sync::Once;
...
mod test_debug_assert_iter_eq {
    ...
    fn success() {
        ...
        let b = [1, 2];
        for _ in 0..1 {
            let _actual = debug_assert_iter_eq!(&a, &b);
            // assert_eq!(actual, ());
        }
    }
