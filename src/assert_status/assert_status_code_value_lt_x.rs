...
#[cfg(test)]
mod test_assert_status_code_value_lt_x_as_result {
    use std::process::Command;
    use std::sync::Once;
    ...
    fn lt() {
        ...
        let b = 2;
        for _ in 0..1 {
            let actual = assert_status_code_value_lt_x_as_result!(a, b);
...
#[cfg(test)]
mod test_assert_status_code_value_lt_x {
    use std::panic;
    use std::process::Command;
    ...
    fn lt() {
        ...
        let b = 2;
        for _ in 0..1 {
            let actual = assert_status_code_value_lt_x!(a, b);
            assert_eq!(actual, 1);
        }
    }
    ...
    fn eq() {
        let result = panic::catch_unwind(|| {
            ...
            a.arg("1");
            let b = 1;
            let _actual = assert_status_code_value_lt_x!(a, b);
        });
        let message = concat!(
            "assertion failed: `assert_status_code_value_lt_x!(a, b)`\n",
            "https://docs.rs/assertables/10.0.0/assertables/macro.assert_status_code_value_lt_x.html\n",
...
#[cfg(test)]
mod test_debug_assert_status_code_value_lt_x {
    use std::panic;
    use std::process::Command;
    ...
    fn lt() {
        ...
        let b = 2;
        for _ in 0..1 {
            let _actual = debug_assert_status_code_value_lt_x!(a, b);
            // assert_eq!(actual, 1);
        }
    }
