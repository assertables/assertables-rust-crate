...
#[cfg(test)]
mod test_assert_fn_ok_ge_as_result {
    // use std::sync::Once;
...
mod test_assert_fn_ok_ge {
    ...
    mod arity_1 {
        ...
        fn lt() {
            let result = panic::catch_unwind(|| {
                let a: i8 = 1;
                let b: i8 = 2;
                let _actual = assert_fn_ok_ge!(f, a, g, b);
            });
            let message = concat!(
                "assertion failed: `assert_fn_ok_ge!(a_function, a_param, b_function, b_param)`\n",
                "https://docs.rs/assertables/10.1.0/assertables/macro.assert_fn_ok_ge.html\n",
    ...
    mod arity_0 {
        ...
        fn lt() {
            let result = panic::catch_unwind(|| {
                let _actual = assert_fn_ok_ge!(f, g);
            });
            let message = concat!(
                "assertion failed: `assert_fn_ok_ge!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.1.0/assertables/macro.assert_fn_ok_ge.html\n",
...
#[cfg(test)]
mod test_debug_assert_fn_ok_ge {
    use std::panic;
    ...
    mod arity_1 {
        ...
        fn gt() {
            ...
            let b: i8 = 1;
            for _ in 0..1 {
                let _actual = debug_assert_fn_ok_ge!(f, a, g, b);
                let _expect = (2, 1);
                // assert_eq!(actual, expect);
            }
        }
    ...
    mod arity_0 {
        ...
        fn gt() {
            for _ in 0..1 {
                let _actual = debug_assert_fn_ok_ge!(g, f);
                let _expect = (2, 1);
                // assert_eq!(actual, expect);
            }
        }
        ...
        fn eq() {
            for _ in 0..1 {
                let _actual = debug_assert_fn_ok_ge!(f, f);
                let _expect = (1, 1);
                // assert_eq!(actual, expect);
            }
        }
        ...
        fn lt() {
            let result = panic::catch_unwind(|| {
                let _actual = debug_assert_fn_ok_ge!(f, g);
            });
            let message = concat!(
                "assertion failed: `assert_fn_ok_ge!(a_function, b_function)`\n",
                "https://docs.rs/assertables/10.1.0/assertables/macro.assert_fn_ok_ge.html\n",
