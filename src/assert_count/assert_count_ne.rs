...
#[cfg(test)]
mod test_assert_count_ne_as_result {
    use std::sync::Once;
    ...
    fn lt() {
        ...
        let b = "xx".chars();
        for _ in 0..1 {
            let actual = assert_count_ne_as_result!(a, b);
...
mod test_assert_count_ne {
    ...
    fn lt() {
        ...
        let b = "xx".chars();
        for _ in 0..1 {
            let actual = assert_count_ne!(a, b);
    ...
    fn failure() {
        let result = panic::catch_unwind(|| {
            let a = "x".chars();
            let b = "x".chars();
            let _actual = assert_count_ne!(a, b);
        });
        let message = concat!(
            "assertion failed: `assert_count_ne!(a, b)`\n",
            "https://docs.rs/assertables/10.0.0/assertables/macro.assert_count_ne.html\n",
...
#[cfg(test)]
mod test_debug_assert_count_ne {
    use std::panic;
    ...
    fn lt() {
        ...
        let b = "xx".chars();
        for _ in 0..1 {
            let _actual = debug_assert_count_ne!(a, b);
            // assert_eq!(actual, (1, 2));
        }
    }
