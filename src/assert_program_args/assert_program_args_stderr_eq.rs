...
#[cfg(test)]
mod test_debug_assert_program_args_stderr_eq {
    use std::panic;
    ...
    fn eq() {
        ...
        let b_program = "bin/printf-stderr";
        let b_args = ["%s", "alfa"];
        let _actual = debug_assert_program_args_stderr_eq!(a_program, a_args, b_program, b_args);
        // assert_eq!(
        //     actual,
        //     (vec![b'a', b'l', b'f', b'a'], vec![b'a', b'l', b'f', b'a'])
        // );
    ...
    fn lt() {
        ...
        let result = panic::catch_unwind(|| {
            let _actual =
                debug_assert_program_args_stderr_eq!(a_program, a_args, b_program, b_args);
        });
        let message = concat!(
            "assertion failed: `assert_program_args_stderr_eq!(a_program, a_args, b_program, b_args)`\n",
            "https://docs.rs/assertables/10.0.0/assertables/macro.assert_program_args_stderr_eq.html\n",
