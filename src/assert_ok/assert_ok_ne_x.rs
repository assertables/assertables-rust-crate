...
#[cfg(test)]
mod test_assert_ok_ne_x_as_result {
    use std::sync::Once;
...
mod test_assert_ok_ne_x {
    ...
    fn eq() {
        ...
        let b: i8 = 1;
        let result = panic::catch_unwind(|| {
            let _actual = assert_ok_ne_x!(a, b);
        });
        let message = concat!(
            "assertion failed: `assert_ok_ne_x!(a, b)`\n",
            "https://docs.rs/assertables/10.0.0/assertables/macro.assert_ok_ne_x.html\n",
...
mod test_debug_assert_ok_ne_x {
    ...
    fn ne() {
        ...
        let b: i8 = 2;
        for _ in 0..1 {
            let _actual = debug_assert_ok_ne_x!(a, b);
            // assert_eq!(actual, 1);
        }
    }
