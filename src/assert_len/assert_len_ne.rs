...
#[cfg(test)]
mod test_assert_len_ne_as_result {
    use std::sync::Once;
...
mod test_debug_assert_len_ne {
    ...
    fn lt() {
        ...
        let b = "xx";
        for _ in 0..1 {
            let _actual = debug_assert_len_ne!(a, b);
            // assert_eq!(actual, (1, 2));
        }
    }
