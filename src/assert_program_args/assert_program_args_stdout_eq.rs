...
#[cfg(test)]
mod test_assert_program_args_stdout_eq_as_result {
    use std::sync::Once;
    ...
    fn eq() {
        ...
        let b_program = "bin/printf-stdout";
        let b_args = ["%s%s%s%s", "a", "l", "f", "a"];
        let actual = assert_program_args_stdout_eq_as_result!(a_program, a_args, b_program, b_args);
        assert_eq!(
            actual.unwrap(),
    ...
    fn eq_once() {
        ...
        let result = assert_program_args_stdout_eq_as_result!(a(), a_args(), b(), b_args());
        assert!(result.is_ok());
...
#[cfg(test)]
mod test_assert_program_args_stdout_eq {
    use std::panic;
    ...
    fn eq() {
        ...
        let b_program = "bin/printf-stdout";
        let b_args = ["%s%s%s%s", "a", "l", "f", "a"];
        let actual = assert_program_args_stdout_eq!(a_program, a_args, b_program, b_args);
        assert_eq!(
            actual,
            (vec![b'a', b'l', b'f', b'a'], vec![b'a', b'l', b'f', b'a'])
        );
    ...
    fn lt() {
        ...
        let b_args = ["%s%s", "z", "z"];
        let result = panic::catch_unwind(|| {
            let _actual = assert_program_args_stdout_eq!(a_program, a_args, b_program, b_args);
        });
        let message = concat!(
            "assertion failed: `assert_program_args_stdout_eq!(a_program, a_args, b_program, b_args)`\n",
            "https://docs.rs/assertables/10.1.0/assertables/macro.assert_program_args_stdout_eq.html\n",
...
#[cfg(test)]
mod test_debug_assert_program_args_stdout_eq {
    use std::panic;
    ...
    fn eq() {
        ...
        let b_program = "bin/printf-stdout";
        let b_args = ["%s%s%s%s", "a", "l", "f", "a"];
        let _actual = debug_assert_program_args_stdout_eq!(a_program, a_args, b_program, b_args);
    ...
    fn lt() {
        ...
        let result = panic::catch_unwind(|| {
            let _actual =
                debug_assert_program_args_stdout_eq!(a_program, a_args, b_program, b_args);
        });
        let message = concat!(
            "assertion failed: `assert_program_args_stdout_eq!(a_program, a_args, b_program, b_args)`\n",
            "https://docs.rs/assertables/10.1.0/assertables/macro.assert_program_args_stdout_eq.html\n",
